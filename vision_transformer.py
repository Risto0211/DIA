...
class trainableoriginalsoftmax(nn.Module): # trainableQuad2 w/o mask
    def __init__(self, attn, input_N_dim=None, S=None, NS=None, num_heads=None, dim=-1, usc_c=True, use_a=False,  use_d=False, use_e=False, args=None):
        ...
        if args.init:
            with torch.no_grad():
                self.d.fill_(args.init_val)
                print (f"init d to {args.init_val}")
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., args=None):
        super().__init__()
        assert dim % num_heads == 0, f'dim should be divisible by num_heads, dim: {dim}, head: {num_heads}'

        # print (f"softmax:{args.softmax_approx}, internal_norm:{args.internal_LN}")
        ...
        # if args.internal_LN:
        #     self.internal_LN=True
        #     self.internal_norm = nn.LayerNorm(args.input_N_dim)
        # else:
        self.internal_LN = False

        # if args.softmax_approx=='original':
        self.softmaxlayer=nn.Softmax(dim=-1)

        # elif args.softmax_approx=='trainableoriginalsoftmaxc':
        ...
        # elif args.softmax_approx=='trainableoriginalsoftmaxd':
        #     self.softmaxlayer=trainableoriginalsoftmax(attn='self',
        #                                        input_N_dim=args.input_N_dim,
        #                                        num_heads=num_heads,
        #                                        dim=-1,
        ...
        # elif args.softmax_approx=='trainableoriginalsoftmaxcd':
        #     self.softmaxlayer=trainableoriginalsoftmax(attn='self',
        #                                        input_N_dim=args.input_N_dim,
        #                                        num_heads=num_heads,
        #                                        dim=-1,
        ...
        # elif args.softmax_approx=='trainableoriginalsoftmaxda':
        #     self.softmaxlayer=trainableoriginalsoftmax(attn='self',
        #                                        input_N_dim=args.input_N_dim,
        #                                        num_heads=num_heads,
        #                                        dim=-1,
        ...
        # elif args.softmax_approx=='trainableoriginalsoftmaxcda':
        #     self.softmaxlayer=trainableoriginalsoftmax(attn='self',
        #                                        input_N_dim=args.input_N_dim,
        #                                        num_heads=num_heads,
        #                                        dim=-1,
        ...
        # elif args.softmax_approx=='trainablequad2c':
        ...
        # elif args.softmax_approx=='trainablequad2d':
        #     self.softmaxlayer=trainableQuad2(attn='self',
        #                                        input_N_dim=args.input_N_dim,
        #                                        num_heads=num_heads,
        #                                        dim=-1,
        ...
        # elif args.softmax_approx=='trainablequad2cd':
        #     self.softmaxlayer=trainableQuad2(attn='self',
        #                                        input_N_dim=args.input_N_dim,
        #                                        num_heads=num_heads,
        #                                        dim=-1,
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.attn = Attention(dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop, args=args)
...
class VisionTransformer(nn.Module):
    ...
    def getLayerOutput(self, x, block_num):
        x = self.patch_embed(x)
    ...
    def getLayerDepthandDim(self, x, block_num):
        depth = int(block_num)
        out = self.getLayerOutput(x, block_num)
        b, n, c = out.shape
        return (b, c, int((n-1)**0.5), int((n-1)**0.5)), depth
...
def vit_tiny_patch8_32(pretrained=False, **kwargs):
    """ ViT-Tiny (Vit-Ti/9)
    """
    model_kwargs = dict(img_size=32, patch_size=8, embed_dim=192, depth=12, num_heads=3, **kwargs)
    model = _create_vision_transformer('vit_tiny_patch8_32', pretrained=pretrained, **model_kwargs)
    return model
...
def vit_tiny_patch4_32(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_tiny_patch4_32', pretrained=pretrained, **model_kwargs)
    return model